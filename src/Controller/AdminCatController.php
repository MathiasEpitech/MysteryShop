...
class AdminCatController extends AbstractController
{
    ...
    public function new(Request $request, CategorieRepository $categorieRepository, EntityManagerInterface $manager,SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("info", "La cetégorie " . $categorie->getNom() . " a bien été ajouté");
    ...
    public function edit(Request $request, Categorie $categorie, EntityManagerInterface $manager,SluggerInterface $slugger): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash("info", "La cetégorie " . $categorie->getNom() . " a bien été modifié");
    ...
    //     $this->addFlash("danger", "La cetégorie " . $categorie->getNom() . " a bien été supprimer");

    //     return $this->redirectToRoute('app_admin_cat_index', [], Response::HTTP_SEE_OTHER);
    // }

    #[Route('/supprimer/{id}', name: 'app_admin_cat_supp')]
