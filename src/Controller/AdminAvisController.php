...
class AdminAvisController extends AbstractController
{
    ...
    public function avisDetail(Avis $avis): Response
    {
    ...
    public function avisDel(Avis $avis, EntityManagerInterface $manager): Response
    {
        ...
        $this->addFlash("danger", "L'avis a bien ete supprimé");
